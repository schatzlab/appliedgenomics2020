...
3. Implement a genomics processing pipeline using WebAssembly [fastq.bio](https://www.smashingmagazine.com/2019/04/webassembly-speed-web-app/)

4. Develop/apply a scalable datastructure for genomics (Note Brad Solomon is willing to help coordinate):
